...
class Cli extends WP_CLI {
	...
	private function build_github_readme( string $version, string $contributors, string $tested_up_to ): string {
		$output  = "<!--\n";
		$output .= "This file is auto-generated by the GatherPress/gatherpress-develop release tooling.\n";
		$output .= "Do not edit it directly: changes are overwritten when the README is regenerated.\n";
		$output .= "To update it, edit the source parts in gatherpress-develop (parts/github/, parts/shared/)\n";
		$output .= "or the assembly in classes/class-cli.php, then regenerate.\n";
		$output .= "-->\n\n";
		$output .= "# GatherPress\n\n";
